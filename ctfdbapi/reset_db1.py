...
from db.database import db_session
 db.models import AttendingTeam, Event, Team, Submission, Flag, Challenge, Member, User, Tick, TeamScriptsRunStatus, Script, ScriptPayload, ScriptRun
...
if __name__ == '__main__':
    ...
    print("---------------------------")
    print(" create teams manually")

    # scorebot muss wissen attending team ID, subnet nummer (unterschiedlich)
